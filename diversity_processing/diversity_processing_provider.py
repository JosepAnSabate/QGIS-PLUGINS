...
from .diversity_processing_algorithm import DiversityProcessingAlgorithm


class DiversityProcessingProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(DiversityProcessingAlgorithm())
